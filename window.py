...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/trash.png"))
        # 图片读取进程
        ...
        self.model = self.model_load(weights="pretrained/yolov5l.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        # 图片检测子界面
        font_title = QFont('楷体', 18)
        font_main = QFont('楷体', 14)
        # 图片识别界面, 两个按钮，上传图片和显示结果
        img_detection_widget = QWidget()
        img_detection_layout = QVBoxLayout()
        img_detection_title = QLabel("图片识别")
        ...
        self.setTabIcon(0, QIcon('images/UI/img.png'))
